function [net, info] = cnn_cifar_riem2_temp(varargin)
...
while hasFrame(v)
    ...
    for tx=tx_range
        outimg2 = imtranslate(outimg,[tx, ty],'FillValues',0);
...
for alpha = 0:theta_steps:1
    ...
    outimg = imresize(dogcat1,[128, 128]);
    for tx=0
