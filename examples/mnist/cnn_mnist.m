...
opts.expDir = fullfile(vl_rootnn, 'data', ['mnist-baseline-' num2str(opts.mnistVer) sfx '_jitter_' num2str(opts.dataJitter) '_layers_num_' num2str(opts.layers_num) '_final_fc_' num2str(opts.final_fc)]) ;
...
if isempty(opts.network)
    ...
    'networkType', opts.networkType, 'layers_num', opts.layers_num, 'final_fc', opts.final_fc) ;
